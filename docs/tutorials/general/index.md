...
Setup, version control, and the tools everyone on the team uses regardless of
what they work on.
...
!!! tip "Something missing?"
    If you got stuck on something these guides don't cover, that's worth writing
    down. Use the [Tutorial Template](../../contributing/templates/tutorial-template.md)
